        ...
        for x in tweet_stream:
            ...
            try:
                ...
                if os.path.exists(filename):
                    ...
                    f = executor.submit(arnold_cat_map, local_image_name, os.path.join(FINAL_IMG_DIR, outname), retain_finals, txt_file)
                    seq = f.result()
...
args = CommandLineArgs(sys.argv, 'file:str:!', 'num_blocks:int:!', 'search_term:str:grand prismatic spring', 'retain_originals:bool:False', 'retain_finals:bool:False')
